...
class AssetPriceController(
    ...
    fun record(
        ...
        @Valid @RequestBody request: RecordAssetPriceRequest
    ): AssetPriceResponse {
        val result = recordAssetPrice.execute(
        ...
        return getAssetPrice.execute(
            GetAssetPrice.Query(result.priceId, request.date)
        ).toResponse()
    }
