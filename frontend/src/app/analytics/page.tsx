                            ...
                            <table aria-label="Performance breakdown">
                                ...
                                <tr>
                                    ...
                                    <td style={{
                                        textAlign: "right",
                                        fontFamily: "var(--font-mono)",
                                        color: (perfFees?.gainLoss ?? 0) >= 0 ? "var(--success)" : "var(--danger)"
                                    }}>
                                    ...
                                    <td style={{
                                        textAlign: "right",
                                        fontFamily: "var(--font-mono)",
                                        color: (perfInflation?.gainLoss ?? 0) >= 0 ? "var(--success)" : "var(--danger)"
                                    }}>
                                ...
                                <tr>
                                    ...
                                    <td style={{
                                        textAlign: "right",
                                        fontFamily: "var(--font-mono)",
                                        color: perf.gainLossBasisPoints >= 0 ? "var(--success)" : "var(--danger)"
                                    }}>
                                    ...
                                    <td style={{
                                        textAlign: "right",
                                        fontFamily: "var(--font-mono)",
                                        color: (perfFees?.gainLossBasisPoints ?? 0) >= 0 ? "var(--success)" : "var(--danger)"
                                    }}>
                                    ...
                                    <td style={{
                                        textAlign: "right",
                                        fontFamily: "var(--font-mono)",
                                        color: (perfInflation?.gainLossBasisPoints ?? 0) >= 0 ? "var(--success)" : "var(--danger)"
                                    }}>
